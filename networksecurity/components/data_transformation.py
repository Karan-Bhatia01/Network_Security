...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        """
        Initializes a KNNImputer object with the parameters specified in training_pipeline.py
        ...
        try:
            ...
            processor: Pipeline = Pipeline([("imputer", imputer)])  # Fixed incorrect Pipeline syntax
            return processor
        except Exception as e:
            raise NetworkSecurityException(str(e), sys)
